            ...
            <div class="grid grid-cols-1 gap-6">
                <div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900/50">
                    ...
                    <div class="p-6 space-y-8">
                        ...
                        <section>
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                <div>
                                    <h4
                                        class="mb-5 flex items-center text-sm font-bold uppercase tracking-wider text-gray-500">
                                        <i class="bi bi-diagram-3 mr-2"></i> Cluster/Division
                                    </h4>

                                    <div class="mb-6 grid grid-cols-2 gap-4">
                                        <label
                                            class="relative flex cursor-pointer rounded-xl border border-gray-200 p-4 transition hover:bg-gray-50 dark:border-gray-800 dark:hover:bg-gray-800">
                                            ...
                                            <div class="flex flex-col peer-checked:text-blue-600">
                                                ...
                                                <span class="text-xs text-gray-500">Assign to a main group</span>
                                            </div>
                                            <i
                                        ...
                                        <label
                                            ...
                                            <div class="flex flex-col peer-checked:text-blue-600">
                                                ...
                                                <span class="text-xs text-gray-500">Assign to specific unit</span>
                                            </div>
                                            <i
                                                class="bi bi-check-circle-fill absolute right-4 top-1/2 -translate-y-1/2 opacity-0 peer-checked:opacity-100 text-blue-600 transition"></i>
                                        </label>
                                ...
                                <div>
                                    <h4
                                        class="mb-5 flex items-center text-sm font-bold uppercase tracking-wider text-gray-500">
                                        <i class="bi bi-shield-lock mr-2"></i> Account Permissions
                                    </h4>
                                    ...
                                    <select name="roles"
                                        ...
                                        @foreach ($roles as $role)
                                            <option value="{{ $role->name }}"
                                                {{ old('roles') == $role->name ? 'selected' : '' }}>{{ $role->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('roles')
                        ...
                        <section>
                            <h4 class="mb-5 flex items-center text-sm font-bold uppercase tracking-wider text-gray-500">
                                <i class="bi bi-key mr-2"></i> Security
                            </h4>
                    ...
                    <div
                        ...
                        <button type="submit"
                            class="inline-flex items-center justify-center rounded-lg bg-blue-600 px-8 py-2.5 text-sm font-bold text-white shadow-lg shadow-blue-200 transition hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:shadow-none">
