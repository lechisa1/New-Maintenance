...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('maintenance_requests', function (Blueprint $table) {
            ...
            $table->enum('status', ['pending', 'assigned', 'in_progress', 'completed', 'rejected','waiting_approval', 'not_fixed','approved','confirmed','pending_approval_review'])->default('pending');
