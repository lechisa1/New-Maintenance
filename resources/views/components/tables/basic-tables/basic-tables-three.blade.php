...
<div x-data="{
    ...
    getStatusClass(status) {
        const classes = {
            ...
            'Pending': 'bg-yellow-50 text-yellow-600 dark:bg-yellow-500/15 dark:text-orange-400',
            'Failed': 'bg-red-50 text-red-600 dark:bg-red-500/15 dark:text-red-500',
            'Verified': 'bg-green-50 text-green-600 dark:bg-green-500/15 dark:text-green-500',
            'Active': 'bg-green-50 text-green-600 dark:bg-green-500/15 dark:text-green-500',
            'Inactive': 'bg-gray-50 text-gray-600 dark:bg-gray-500/15 dark:text-gray-500',
        };
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <template x-for="transaction in paginatedTransactions" :key="transaction.id">
                            <tr>
                                ...
                                <td class="px-4 py-4 whitespace-nowrap">
                                    <span class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full" :class="getStatusClass(transaction.status)" x-text="transaction.status"></span>
                                </td>
                                <td class="px-4 py-4 text-sm font-medium text-right whitespace-nowrap">
                                    <div class="flex justify-center relative">
                                        <x-common.table-dropdown>
                                            ...
                                            <x-slot name="content">
                                                <a :href="'/transactions/' + transaction.id" class="flex w-full px-3 py-2 font-medium text-left text-gray-500 rounded-lg text-theme-xs hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300" role="menuitem">
                                                    View More
                                                </a>
                                                <a :href="'/transactions/' + transaction.id + '/delete'" class="flex w-full px-3 py-2 font-medium text-left text-gray-500 rounded-lg text-theme-xs hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300" role="menuitem">
                                                    Delete
                                                </a>
                                            </x-slot>
                                        </x-common.table-dropdown>
