...
@section('content')
    ...
    <div class="space-y-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
            <form action="{{ route('maintenance-requests.index') }}" method="GET" id="filterForm" class="space-y-4">
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Debounced auto-submit for search (waits 600ms after last keystroke)
            let typingTimer;
