<div x-data="{ showRejectAssignerModal: false }" @open-reject-assigner-modal.window="showRejectAssignerModal = true">
    <!-- Modal triggered from quick actions for assigners -->

    <div x-show="showRejectAssignerModal" x-cloak style="display: none;"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md">
            <div class="flex justify-between items-center mb-4">
                ...
                <button @click="showRejectAssignerModal = false"
            ...
            <form action="{{ route('maintenance-requests.reject', $maintenanceRequest) }}" method="POST"
                id="reject-request-assigner-form">
                @csrf
                <div class="space-y-4">
                    <div>
                    ...
                    <div class="flex justify-end gap-3">
                        <button type="button" @click="showRejectAssignerModal = false"
