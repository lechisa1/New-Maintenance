    ...
    <div class="pt-8 pb-7 flex"
        ...
        <a href="/">
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="dark:hidden" src="https://products.aii.et/assets/img/AII-logo.png" alt="Logo" width="100" height="30" />
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="hidden dark:block" src="https://products.aii.et/assets/img/AII-logo.png" alt="Logo" width="100"
                height="20" />
            <img x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
                src="https://products.aii.et/assets/img/AII-logo.png" alt="Logo" width="40" height="40" />
