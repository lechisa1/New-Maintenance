            ...
            @if ($items->count() > 0)
                ...
                <div class="mt-6 border-t border-gray-200 pt-6 dark:border-gray-700">
                    <div class="text-sm text-gray-500 dark:text-gray-400">
                        <p class="mb-3"><i class="bi bi-info-circle me-2"></i>Deleted equipment can be restored within 30
                            days.</p>

                        <div class="flex gap-3">
                            <form action="{{ route('items.restore.all') }}" method="POST"
                                onsubmit="return confirm('Are you sure you want to restore all deleted equipment?')">
                                @csrf
                                <button type="submit"
                            ...
                            <form action="{{ route('items.forceDelete.all') }}" method="POST"
                                onsubmit="return confirm('Are you sure you want to permanently delete ALL equipment? This action cannot be undone!')">
                                @csrf
                                <button type="submit"
